                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="d-block">{{ __('message.add_property_limit') }} </label>
                                    </div>
                                    <div class="col-4">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            {{ Form::radio('add_property', '0', old('add_property') || true , [ 'class' => 'custom-control-input', 'id' => 'add_property-limit']) }}
                                            {{ Form::label('add_property-limit', __('message.limit'), ['class' => 'custom-control-label' ]) }}
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            {{ Form::radio('add_property', '1', old('add_property') , [ 'class' => 'custom-control-input', 'id' => 'add_property-unlimited']) }}
                                            {{ Form::label('add_property-unlimited', __('message.unlimited'), ['class' => 'custom-control-label' ]) }}
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group col-md-3 add_property_limit">
                                {{ Form::label('limit', __('message.limit').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label' ], false ) }}
                                {{ Form::number('add_property_limit', old('add_property_limit'),['min'=> 0, 'placeholder' => __('message.add_property_limit'), 'class' => 'form-control add-property-limit']) }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="d-block">{{ __('message.property_limit') }} </label>
                                    </div>
                                    <div class="col-4">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            {{ Form::radio('property', '0', old('property') || true , [ 'class' => 'custom-control-input', 'id' => 'property-limit']) }}
                            ...
                            <div class="form-group col-md-3 property_limit">
                                {{ Form::label('limit', __('message.limit').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label' ], false ) }}
                                {{ Form::number('property_limit', old('property_limit'),['min'=> 0, 'placeholder' => __('message.property_limit'), 'class' => 'form-control property-limit']) }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="d-block">{{ __('message.advertisement_limit') }} </label>
                                    </div>
                                    <div class="col-4">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            {{ Form::radio('advertisement', '0', old('advertisement') || true , [ 'class' => 'custom-control-input', 'id' => 'advertisement-limit']) }}
                            ...
                            <div class="form-group col-md-3 advertisement_limit">
                                {{ Form::label('limit', __('message.limit').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label' ], false ) }}
                                {{ Form::number('advertisement_limit', old('advertisement_limit'),['min'=> 0, 'placeholder' => __('message.advertisement_limit'),'class' =>'form-control advertisement-limit']) }}
                            </div>
                        </div>
