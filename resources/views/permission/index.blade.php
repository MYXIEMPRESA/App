                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-checkbox">
                                                            <input class="checkbox no-wh permission_check custom-control-input custom-checkbox-class" id="permission-{{$role->id}}-{{$p->id}}" type="checkbox" name="permission[{{$p->name}}][]" value='{{$role->name}}' {{ (checkRolePermission($role,$p->name)) ? 'checked' : '' }} @if($role->is_hidden) disabled @endif >
                                                            <label class="custom-control-label" for="permission-{{$role->id}}-{{$p->id}}"></label>
                                                        </div>
                                                    </td>
                                                    @endforeach
                                                </tr>
