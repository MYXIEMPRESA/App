            ...
            <div class="card card-block card-stretch">
                <div class="card-body p-0">
                    <div class="d-flex justify-content-between align-items-center p-3">
                        ...
                        <a href="{{ route('builder.index') }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('message.back') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a href="{{ route('builder.show', $data->id) }}" class="nav-link {{ $type == 'detail' ? 'active': '' }}"> {{ __('message.detail') }} </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('builder.show', [ 'id' => $data->id, 'type' => 'property']) }}" class="nav-link {{ $type == 'property' ? 'active': '' }}"> {{ __('message.property') }} </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('builder.show', [ 'id' => $data->id, 'type' => 'subscription']) }}" class="nav-link {{ $type == 'subscription' ? 'active': '' }}"> {{ __('message.subscription') }} </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('builder.show', [ 'id' => $data->id, 'type' => 'extrapropertylimit']) }}" class="nav-link {{ $type == 'extrapropertylimit' ? 'active': '' }}"> {{ __('message.extrapropertylimit') }} </a>
                        </li>
                    </ul>
