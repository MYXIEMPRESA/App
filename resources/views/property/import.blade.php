...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {{ Form::open(['route' => 'import.property', 'method' => 'post', 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator' ]) }}
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-control-label" for="customFile">{{ __('message.file') }} </label>
                    <div class="custom-file text-left">
                        <input type="file" name="property_file" class="custom-file-input" id="customFile"  accept=".csv" required="required" />
