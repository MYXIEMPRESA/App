<x-app-layout :assets="$assets ?? []">
    <div>
        <?php $id = $id ?? null;?>
        @if(isset($id))
            {!! Form::model($data, [ 'route' => ['article.update', $id], 'method' => 'patch', 'enctype' => 'multipart/form-data' ]) !!}
        @else
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                {{ Form::label('name', __('message.article_name').' <span class="text-danger">*</span>',[ 'class' => 'form-control-label' ], false ) }}
                                {{ Form::text('name', old('name'),[ 'placeholder' => __('message.article_name'),'class' =>'form-control','required']) }}
                            </div>
                            <div class="form-group col-md-6">
