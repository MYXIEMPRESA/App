...
class CustomerDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('status', function($data) {
                $action_type = 'status';
                return view('customer.action',compact('data','action_type'))->render();
            })
            ...
            ->addColumn('action', function($customer){
                $id = $customer->id;
                $action_type = 'action';
                return view('customer.action',compact('customer','action_type','id'))->render();
            })
            ->addIndexColumn()
    ...
    {
        $model = User::where('user_type', 'user')->whereNULL('is_agent')->whereNULL('is_builder');
